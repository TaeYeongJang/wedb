...
<head>
    ...
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script> -->
 	...
 	<style>
			...
			.carousel dl:first-of-type {
			  position: relative;
			  opacity: 1;
			}
			
			.carousel dt, .carousel dd {
			  margin: 0;
			  padding: 0;
			  color: #ffffff; /* 텍스트 색상 */
			}
			...
			.carousel dl:nth-child(1) {
			  animation-delay: 0s;
			}
			.carousel dl:nth-child(2) {
			  animation-delay: 4s;
			}
			.carousel dl:nth-child(3) {
			  animation-delay: 8s;
			}
	    ...
	    function getAwsBonbuList() {
	        ...
	        const rst = ajaxPost(awsInfo);
		 	...
		 	if(!rst) {
 				...
 				html += '</span></dd></dl><div class="carousel">';
		 	   ...
		 	   for (var i = 0; i < rst.length; i++) {
			 	   ...
			 	   if( rst[i].HO_NAME != '제주' && rst[i].HO_NAME != '전국') {
			 		    ...
			 		    if ( i == 0 )
			 		    	html += '<dl class="average_data_area"><dt>지역 누적 평균강수(mm)</dt><dd><span class="title">';
			 			else
			 				html += '<dl class="average_data_area"><dt>지역 누적 평균강수(mm)</dt><dd><span class="title">';
