...
<head>
  ...
  <%--   <link href="<c:url value='/resources/wrms/image/favicon.png'/>" rel="shortcut icon" type="image/x-icon">  --%>
	...
	<script type="text/javascript">
		...
		var taxiIcon = L.icon({
			iconUrl: "<c:url value='/resources/sass/images/common/taxi.png'/>",
			iconSize: [70, 70]
		})
		...
		function load_data(need_init) {
			...
			param.successFn	= function (data){
				...
				windyInit(options, windyAPI => {
					...
					var marker = L.marker([37.390476, 127.492516], { icon: taxiIcon }).addTo(map);
