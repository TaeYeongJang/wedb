...
<body>
    ...
    <header id="header">
       <div class="header__wrap">
            <h1><a href=""><img src="images/common/logo.png" alt="DIMAS 재난안전종합상황실"></a></h1>
            <nav id="nav">
                <ul class="main-menu">
                    <li><a href="">가뭄</a></li>
                    <li><a href="" class="on">홍수</a></li>
    ...
    <section id="main_container">
        ...
        <div class="inner_map">
            ...
            <div class="popup_emergency_duty" style="position:absolute;left:50%;top:30%;transform:translate(-50%,-30%);">
                <div class="duty__top">
                ...
                <ul class="duty__list scrollbar_custom">  
                    <li>
                        ...
                        <h4 class="title">10월 29일 충북 괴산군 지진 규모 4.1</h4>
                        <p class="region">충북,괴산군</p>
                    </li>
                    <li>
                        <i class="fa-regular fa-clock"></i>
                        <span class="datetime">[2022-10-29 08:20~]</span>
            ...
            <div class="warning_box">
                <p>발표시각 2022.11.04 20:00 <span>강풍주의보 해제</span></p>
            </div>
            <!-- 지도상단검색바 -->
            <div class="search_bar_sub">
                <form>                        
                    <label for="map-select"><span class="label_tit">지도선택</span></label>
                    <select id="map-select" name="map" class="select_type1">
            ...
            <div class="sub_menu">
                <ul>
                    <li><a href="" class="on">기상특보</a></li>
                    <li><a href="">강수현황</a></li>
                    <li><a href="">현저수율현황</a></li>
                    <li><a href="">배수장가동현황</a></li>
                    <li><a href="">방조제방류현황</a></li>
                    <li><a href="">저수지방류현황</a></li>
                    <li><a href="">홍수예측분석</a></li>
                </ul>
            </div>
            <hr>
            <!-- 플레이바 -->
            ...
            <!-- 클릭시팝업 -->
            <!-- 1 -->
            <div class="map_popup3" style="position:absolute;top:30%;left:50%">
                <h3>경기</h3>
                <span class="point popcolor_step1"></span>
                <p>110%</p>
            </div>         
             <!-- 1 -->
             <div class="map_popup3" style="position:absolute;top:40%;left:50%">
                <h3>충북</h3>
                <span class="point popcolor_step1"></span>
                <p>100%</p>
            </div>     
             <!-- 1 -->
             <div class="map_popup3" style="position:absolute;top:50%;left:50%">
                <h3>전북</h3>
                <span class="point popcolor_step1"></span>
                <p>76%</p>
            </div>       
             <!-- 수위,유량표시 --> 
             <div class="map_popup3" style="position:absolute;top:60%;left:50%">
                <h3>전북</h3>
                <span class="point popcolor_step1"></span>
                <ul>
                    <li><span class="tit">수위</span><span class="txt">1.34</span></li>
                    <li><span class="tit">유량</span><span class="txt">0.0220220220224</span></li>
                </ul>
            </div>     
            ...
            <div class="legend_box">              
                <ul class="legend__type1">
                    <li><span class="step_point2 bgcolor_wind1"></span>강풍주의보</li>
                    <li><span class="step_point2 bgcolor_wind2"></span>강풍경보</li>
                    <li><span class="step_point2 bgcolor_wind3"></span>호우주의보</li>
                    <li><span class="step_point2 bgcolor_wind4"></span>호우경보</li>
                    <li><span class="step_point2 bgcolor_wind5"></span>태풍주의보</li>
                    <li><span class="step_point2 bgcolor_wind6"></span>태풍경보</li>
                </ul>
            </div>
            <hr>             
        </div>
    ...
    <section id="rnb">
        ...
        <!-- 상단타이틀 -->
            ...
            <hr>
            <h3 class="main_title">기상특보</h3>             
            <!-- 결과테이블 -->
            <div class="status__table">
                <div class="news_flash">
                    <h5>비상근무현황</h5>
                    <p><span class="date">[2022-10-29 08:20]</span>  10월 29일 충북 괴산군 지진 규모 4.1 </p>
            ...
            <div class="main_chart">
                <h3 class="main_title">평균 저수율 래프타이틀있을때 적용 <span class="amount">전국 : 강수율 84% 저수율 95%</span></h3>
