...
<head>
    ...
    <script src="${contextPath}/resources/external/bootstrap/js/bootstrap.min2.js"></script>
    <link rel="stylesheet" type="text/css" href="${contextPath}/resources/external/bootstrap/css/bootstrap.min2.css" /> 
                    ...
                    for (var i = 0; i < rst.length; i++) {
                        ...
                        html += row.DD;
                      	html += '</p><p class="year">';
                   		...
                   		html += row.T1;
                   		html += '</p><a href="" class="detail_view">자세히보기</a></dd></dl>';
                    } 
	    ...
	    function getAwsBonbuList() {
	        ...
	        const rst = ajaxPost(awsInfo);
		 	...
		 	if(!rst) {
	 	    	...
	 	    	if ( rst[0].AVG_RAIN >= 0 )
	 	   			html += '<i class="fa-solid fa-arrow-down-long"></i>' ;
	 			else
	 				html += '<i class="fa-solid fa-arrow-down-long"></i>' ;
		 	   ...
		 	   for (var i = 0; i < rst.length; i++) {
			 	   ...
			 	   if( rst[i].HO_NAME != '제주' && rst[i].HO_NAME != '전국') {
			 		    ...
			 		    if ( i == 0 )
			 		    	html += '<div class="mySlideDiv fade active"><dl class="average_data_area"><dt>지역 누적 평균강수(mm)</dt><dd><span class="title">';
			 			else
			 				html += '<div class="mySlideDiv fade"><dl class="average_data_area"><dt>지역 누적 평균강수(mm)</dt><dd><span class="title">';
