		    	         ...
		    	         var width = '70px';
		    	      	...
		    	      	for(key in data){
		    				...
		    				/* var marker = L.marker(markerPoint.reverse(), {
		    	      		...
		    	      		//// 팝업 생성
							var popup = L.popup({
							  closeButton: false, // 팝업 닫기 버튼 숨기기
							  autoClose: true // 맵 클릭시 팝업 자동 닫기
							});
							
							// 마커를 생성하고 팝업을 지도에 추가합니다.
							var marker = L.marker([37.566345, 126.977893]).addTo(map);
							marker.on('click', function(e) {
							  // 팝업을 열기 전에 지도를 팝업이 위치할 중앙으로 이동시킵니다.
							  map.setView(e.latlng, map.getZoom());
							
							  // 팝업 위치를 지정하고 업데이트합니다.
							  popup.setLatLng(e.latlng);
							  popup.setContent('Popup content');
							  popup.update();
