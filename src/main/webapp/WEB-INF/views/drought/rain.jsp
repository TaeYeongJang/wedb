...
<head>
 ...
 <style>
		...
		#windy .leaflet-popup-content-wrapper, #windy .leaflet-popup-tip {
		    background: rgb(235 235 235 / 8)0;
		}
     ...
     <script type="text/javascript">
	    ...
	    const labelContent = ( AVG_RATIO, OBSNM ) => {
	    	...
	    	var warn; 
	    	if(AVG_RATIO > 65) 		 					warn = '<span class="point popcolor_step1"></span><p class="popcolor_step1">'; 
	    	else if(AVG_RATIO > 55 && AVG_RATIO <= 65) 	warn = '<span class="point popcolor_step2"></span><p class="popcolor_step2">'; 
	    	else if(AVG_RATIO > 45 && AVG_RATIO <= 55) 	warn = '<span class="point popcolor_step3"></span><p class="popcolor_step3">';
	    	else 					 					warn = '<span class="point popcolor_step4"></span><p class="popcolor_step4">'; 
	    	
	    	if( AVG_RATIO == 0 ) AVG_RATIO 	= '-'; 
	    	else 				 AVG_RATIO 	= AVG_RATIO + '%'; 
	    	
		   return  '<div class="map_popup" style="position:absolute; width:'+ width + ' ">' +
		           '<h3>'+ OBSNM +'</h3>'  + warn + AVG_RATIO + '</p></div>';
