				...
				windyInit(options, windyAPI => {
				   ...
				   const latlngs = [
					 ...
					 for (let i = 0; i < latlngs.length; i++) {
					   ...
					   const popupContent = '<div class="video-wrapper"> <iframe class="youtube-video" src="${video.url}" frameborder="0" allowfullscreen></iframe> </div>';

					   marker.bindPopup(popupContent, { minWidth: 300, maxWidth: 600, maxHeight: 400 });
					   
					   markers.push(marker);
					 }

					 // Open all popups on page load
					 setTimeout(() => {
