			...
			param.successFn	= function (data){
				...
				windyInit(options, windyAPI => {
				   ...
				   for (var i = 0; i < videos.length; i++) {
				     var video = videos[i];
				     var marker = L.marker([video.latitude, video.longitude])
				       .addTo(map)
				       .bindPopup("<iframe width='560' height='315' src='" + video.url + "' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>")
